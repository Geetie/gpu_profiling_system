    ...
    def _get_tool_guidance(self, stage: PipelineStage, ctx: PipelineContext | None = None) -> str:
        ...
        if stage == PipelineStage.CODE_GEN:
            return (
                ...
                "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
                "🔒 TOOL CALL SEQUENCE LOCK — SYSTEM ENFORCED\n"
                "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
                "The system ENFORCES this rule:\n"
                "- After compile_cuda succeeds, ONLY execute_binary is allowed\n"
                "- Calling compile_cuda again will be BLOCKED until execute_binary completes\n"
                "- You have NO CHOICE — you MUST call execute_binary next\n\n"
                "If you see 'BLOCKED: compile_cuda called while execute_binary is pending',\n"
                "it means you are VIOLATING the sequence. STOP and call execute_binary NOW.\n\n"
                "Example of what happens if you violate:\n"
                "  Turn 1: compile_cuda → success (binary created)\n"
                "  Turn 2: compile_cuda → BLOCKED (system rejects)\n"
                "  Turn 3: compile_cuda → BLOCKED (system rejects)\n"
                "  ... (wasting turns until timeout)\n\n"
                "  CORRECT:\n"
                "  Turn 1: compile_cuda → success\n"
                "  Turn 2: execute_binary → success (measurement obtained)\n"
                "  Turn 3: compile_cuda (for next target) → success\n"
                "  Turn 4: execute_binary → success\n\n"
                "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
